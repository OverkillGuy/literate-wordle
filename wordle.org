...
#+NAME: scoring-answer-literal
#+CAPTION: An answer is any of these characters
#+begin_src python :tangle no
OK = "🟩"
WRONG_PLACE = "🟨"
NOT_THERE = "⬜"
...
And now the function all tangled out!
#+NAME: scoring-impl-tangleweb
#+begin_src python :tangle src/literate_wordle/guess.py :exports none :noweb yes
<<scoring-guessmod-header>>


<<scoring-guessfunc-proto1>>
#+end_src

#+NAME: scoring-test1-tangleweb
#+begin_src python :tangle tests/test_scoring_guess.py :exports none :noweb yes
